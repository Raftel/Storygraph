...
public class AppearAnimation {
	...
	private AppearAnimationCallback mCallback = null;
	private AppearAnimation mNextAnimation = null;
	private ArrayList<AppearAnimationProp> mPropList = null;
	...
	public AppearAnimation(long delay, long duration, int interpolationType) {
		mStatus = STATE_STOPPED;
		mDelay = delay;
		mDuration = duration;
		mEaseFunc = interpolationType;
		mPropList = new ArrayList<AppearAnimationProp>();
	}
	...
	public void setCallback(AppearAnimationCallback callback) {
		mCallback = callback;
	}
	...
	public void addNextAnimation(AppearAnimation nextAnimation) {
		mNextAnimation = nextAnimation;
	}

	public void addProperty(AppearAnimationProp prop) {
		mPropList.add(prop);
	}
