...
public class AppearAnimationProp {
	...
	public AppearAnimationProp(int propType, View view, float fromValue, float toValue) {
		mPropType = propType;
		mView = view;
	...
	public AppearAnimationProp(int propType, AppearNode node, float fromValue, float toValue) {
		mPropType = propType;
		mNode = node;
		mStartValue = fromValue;
		mEndValue = toValue;
	...
	public AppearAnimationProp(CustomCallback callback, float fromValue, float toValue) {
