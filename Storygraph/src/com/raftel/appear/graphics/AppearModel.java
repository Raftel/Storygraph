...
public class AppearModel extends AppearNode {

	private AppearMesh mMesh;
	private AppearMaterial mMaterial;
	...
	public boolean isTextureLoaded() {
		...
		return getMaterial().getTexture() != AppearMaterial.INVALID_TEXTURE_ID;
	}
